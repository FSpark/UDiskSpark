...
// the Everything taskbar notification window is always created when Everything is running.
...
#define EVERYTHING_IPC_DRIVE											0x00000002	// The folder is a drive. Path will be an empty string. (same as root)
#define EVERYTHING_IPC_ROOT												0x00000002	// The folder is a root. 
...
typedef struct EVERYTHING_IPC_QUERY2
{
	...
	// if Everything does not have this sort type as a fast sort type, then it will default to by name.
	DWORD sort_type;
...
typedef struct EVERYTHING_IPC_ITEM2
{
	...
	// if EVERYTHING_IPC_QUERY2_REQUEST_NAME was set in request_flags, DWORD name_length (excluding the null terminator); followed by null terminated text.
	// if EVERYTHING_IPC_QUERY2_REQUEST_PATH was set in request_flags, DWORD name_length (excluding the null terminator); followed by null terminated text.
	...
	// if EVERYTHING_IPC_QUERY2_REQUEST_EXTENSION was set in request_flags, DWORD name_length (excluding the null terminator); followed by null terminated text;
	// if EVERYTHING_IPC_QUERY2_REQUEST_TYPE_NAME was set in request_flags, DWORD name_length (excluding the null terminator); followed by null terminated text;
	...
	// if EVERYTHING_IPC_QUERY2_REQUEST_FILELIST_FILENAME was set in request_flags, DWORD name_length (excluding the null terminator); followed by null terminated text;
	...
	// if EVERYTHING_IPC_QUERY2_REQUEST_HIGHLIGHTED_NAME was set in request_flags, DWORD name_length (excluding the null terminator); followed by null terminated text; ** = *, *text* = highlighted text
	// if EVERYTHING_IPC_QUERY2_REQUEST_HIGHLIGHTED_PATH was set in request_flags, DWORD name_length (excluding the null terminator); followed by null terminated text; ** = *, *text* = highlighted text
	// if EVERYTHING_IPC_QUERY2_REQUEST_HIGHLIGHTED_FULL_PATH_AND_NAME was set in request_flags, DWORD name_length (excluding the null terminator); followed by null terminated text; ** = *, *text* = highlighted text
